...
const Login = () => {
  const { login, loginWithGoogle, resetPassword, isAuthenticated, isLoading, error, clearError } = useAuthStore();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200 mt-2">Enterprise Email Marketing Platform</p>
        </div>
          ...
          {showReset ? (
            ...
            <>
              ...
              <form onSubmit={handleReset} className="space-y-4">
                ...
                <button type="button" onClick={() => { setShowReset(false); clearError(); }} className="w-full text-center text-sm text-gray-500 hover:text-blue-600 font-medium">
                  Back to login
                </button>
              </form>
            </>
            ...
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex items-center justify-end">
                  <button type="button" onClick={() => { setShowReset(true); clearError(); }} className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                    Forgot password?
                  </button>
                </div>
